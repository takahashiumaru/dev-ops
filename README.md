...
Migrations create authentication, GitHub cache, sync history, and metric snapshot tables. `npm run db:migrate` applies every SQL migration in filename order.
...
- Optional: `VPS_USER` (defaults to `ubuntu`), `VPS_NAME`, `AUTH_SECRET`
# dev-ops
